...
# plot loss_record
plt.figure(2)
loss_save_path1 = "E:\\课程及其实验\\毕业设计\\DataFiles\\DecodedData\\loss_record1.txt"
loss_save_path2 = "E:\\课程及其实验\\毕业设计\\DataFiles\\DecodedData\\loss_record2.txt"
loss_record1 = np.loadtxt(loss_save_path1)
loss_record2 = np.loadtxt(loss_save_path2)
plt.plot(loss_record1)
